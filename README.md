...
- Able to use mouse click to select and navigate cells
...
It follows the Model-View-Controller (MVC) design pattern and separates the game logic from the user interface.
